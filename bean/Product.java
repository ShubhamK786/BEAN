...
public class Product {
	...
	@ManyToMany
	@JoinTable(name = "merchant_product", joinColumns = @JoinColumn(name = "merchant_id"), inverseJoinColumns = @JoinColumn(name = "prod_id"))
	private List<Merchant> merchantProduct;

	@ManyToMany
	@JoinTable(name = "prod_images", joinColumns = @JoinColumn(name = "prod_id"), inverseJoinColumns = @JoinColumn(name = "image_id"))
	...
	@ManyToMany
	@JoinTable(name = "cart_product", joinColumns = @JoinColumn(name = "cart_id"), inverseJoinColumns = @JoinColumn(name = "prod_id"))
